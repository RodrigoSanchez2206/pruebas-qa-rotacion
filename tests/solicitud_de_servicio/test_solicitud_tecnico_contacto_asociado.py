...
class tecnicoyCuentaAsociado(BaseTest):
    ...
    def test_crear_solicitudes_para_tipos_y_validar_envio(self):
        ...
        for tipo in tipos:
            ...
            solicitud_page.verificar_enlace_por_texto("Rodrigo Sanchez")
            assert solicitud_page.validar_texto_de_tecnico("T-000"), "Técnico no asociado correctamente"
